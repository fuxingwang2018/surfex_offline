...
# Definations
# ALADIN 12km
HCLIMARCH=/nobackup/rossby21/sm_fuxwa/SURFEX_FORCING/HCLIM38_FORC/MUMS/HCLIM38_SIM_2D/NorCP_ALADIN_ERAI
HCLIMNAME=NorCP_ALADIN_ERAI_1997_2017_3H_500m
OUTF_NAME_TMP=HCLIM38_FORC_${SURFEXEXP}_ALADIN12km_TMP_${HCLIMDTG}.nc
...
IN_NC_TAIR=${HCLIMARCH}/${HCLIMTIME}/${VAR_TAIR}_${HCLIMNAME}_${HCLIMDTG}.nc

# Qair, huss_fp, "Near_Surface_Specific_Humidity" ; units = "Kg/Kg" ; measurement_height = "30m" ;
IN_NC_QAIR=${HCLIMARCH}/${HCLIMTIME}/${VAR_QAIR}_${HCLIMNAME}_${HCLIMDTG}.nc

# Wind, uas_fp vas_fp, "Wind_Speed" ; units = "m/s" ; measurement_height = "30m" ;
IN_NC_UAS=${HCLIMARCH}/${HCLIMTIME}/${VAR_UAS}_${HCLIMNAME}_${HCLIMDTG}.nc
IN_NC_VAS=${HCLIMARCH}/${HCLIMTIME}/${VAR_VAS}_${HCLIMNAME}_${HCLIMDTG}.nc
# Wind_DIR "Wind_Direction" ; units = "deg" ;

# DIR_SWdown, rsdsdir: "Surface_Indicent_Direct_Shortwave_Radiation" ; units = "W/m2" ; 
IN_NC_DIR_SWDOWN=${HCLIMARCH}/${HCLIMTIME}/${VAR_DIR_SWDOWN}_${HCLIMNAME}_${HCLIMDTG}.nc
# SWdown, rsds: "Surface_Indicent_Shortwave_Radiation" ; units = "W/m2" ; 
IN_NC_SWDOWN=${HCLIMARCH}/${HCLIMTIME}/${VAR_SWDOWN}_${HCLIMNAME}_${HCLIMDTG}.nc

# SCA_SWdown, rsds-rsdsdir, "Surface_Incident_Diffuse_Shortwave_Radiation" ; units = "W/m2" ;
#cdo setname,rsdssca -sub ${IN_NC_SWDOWN} ${IN_NC_DIR_SWDOWN} ${HCLIM_FORC_OUT}/rsdssca_${HCLIMNAME}_${HCLIMDTG}.nc
cdo sub ${IN_NC_SWDOWN} ${IN_NC_DIR_SWDOWN} ${HCLIM_FORC_OUT}/${VAR_SCA_SWDOWN}_${HCLIMNAME}_${HCLIMDTG}_tmp.nc
cdo chname,${VAR_SWDOWN},${VAR_SCA_SWDOWN} ${HCLIM_FORC_OUT}/${VAR_SCA_SWDOWN}_${HCLIMNAME}_${HCLIMDTG}_tmp.nc ${HCLIM_FORC_OUT}/${VAR_SCA_SWDOWN}_${HCLIMNAME}_${HCLIMDTG}.nc
rm -f ${HCLIM_FORC_OUT}/${VAR_SCA_SWDOWN}_${HCLIMNAME}_${HCLIMDTG}_tmp.nc
IN_NC_SCA_SWDOWN=${HCLIM_FORC_OUT}/${VAR_SCA_SWDOWN}_${HCLIMNAME}_${HCLIMDTG}.nc

# LWdown, rlds: "Surface_Incident_Longwave_Radiation" ; units = "W/m2" ;
IN_NC_LWDOWN=${HCLIMARCH}/${HCLIMTIME}/${VAR_LWDOWN}_${HCLIMNAME}_${HCLIMDTG}.nc

# PSurf, ps_fp: "Surface_Pressure" ; units = "Pa" ;
IN_NC_PSURF=${HCLIMARCH}/${HCLIMTIME}/${VAR_PSURF}_${HCLIMNAME}_${HCLIMDTG}.nc

# Rainf, prrain: "Rainfall_Rate" ; units = "Kg/m2/s" ;
IN_NC_PRRAIN=${HCLIMARCH}/${HCLIMTIME}/${VAR_PRRAIN}_${HCLIMNAME}_${HCLIMDTG}.nc

# Snowf, prsnow: "Snowfall_Rate" ; units = "Kg/m2/s" ;
IN_NC_PRSNOW=${HCLIMARCH}/${HCLIMTIME}/${VAR_PRSNOW}_${HCLIMNAME}_${HCLIMDTG}.nc
...
rm -f ${HCLIM_FORC_OUT}/${VAR_SCA_SWDOWN}_${HCLIMNAME}_${HCLIMDTG}.nc
