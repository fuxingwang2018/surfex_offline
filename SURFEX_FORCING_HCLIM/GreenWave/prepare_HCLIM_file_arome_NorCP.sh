...
IN_NC_PR=${HCLIMARCH}/${HCLIMTIME}/${VAR_PR}_${HCLIMNAME}_${HCLIMDTG}.nc
cdo sub ${IN_NC_PR} ${IN_NC_PRSNOW} ${HCLIM_FORC_OUT}/${VAR_PRRAIN}_${HCLIMNAME}_${HCLIMDTG}_tmp.nc
cdo chname,${VAR_PR},${VAR_PRRAIN} ${HCLIM_FORC_OUT}/${VAR_PRRAIN}_${HCLIMNAME}_${HCLIMDTG}_tmp.nc ${HCLIM_FORC_OUT}/${VAR_PRRAIN}_${HCLIMNAME}_${HCLIMDTG}.nc
rm -f ${HCLIM_FORC_OUT}/${VAR_PRRAIN}_${HCLIMNAME}_${HCLIMDTG}_tmp.nc
