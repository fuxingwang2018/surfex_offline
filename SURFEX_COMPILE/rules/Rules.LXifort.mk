...
#
OPT_BASE  =  -g -traceback -noauto -convert big_endian -assume byterecl -fpic -O2 -fp-model strict -ftz -r8 -qopenmp -qopenmp-threadprivate compat
...
FX90FLAGS     =  $(OPT) 
#
LDFLAGS   =   -pc 64 -fp-stack-check -qopenmp -qopenmp-threadprivate compat -convert big_endian -assume byterecl
#
# preprocessing flags 
#
