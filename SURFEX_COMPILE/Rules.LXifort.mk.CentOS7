...
OPT_CHECK  =  -fp-stack-check -ftrapuv -fpe0 -fp-speculation=strict -check all -check noarg_temp_created -init=arrays -init=snan
...
LDFLAGS    =   -Wl,-warn-once $(PAR) -qopenmp -qopenmp-threadprivate=compat
#
CC = icc
#
